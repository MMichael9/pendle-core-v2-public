...
/**
 * @title PendleMarketV6Local
 * @notice Local testing version of PendleMarketV6 without PendleGauge dependency.
 * @dev Identical to PendleMarketV6 but removes vePendle/gaugeController requirements.
 *      All core AMM logic preserved: mint, burn, swap, oracle.
 *      Gauge/reward functions stubbed (return 0/empty).
 */
contract PendleMarketV6Local is PendleERC20, TokenHelper, IPMarket {
    ...
    // =========================================================================
    // GAUGE/REWARDS - STUBBED (IPGauge interface requirements)
    // =========================================================================

    function redeemRewards(address) external nonReentrant returns (uint256[] memory) {
    ...
    function activeBalance(address) external pure returns (uint256) {
        return 0;
    }
